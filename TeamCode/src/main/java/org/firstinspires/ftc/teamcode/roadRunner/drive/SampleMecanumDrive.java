...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static final Boolean use2WheelTrackingLocalizer = true;
    public static final Boolean use3WheelTrackingLocalizer = false;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        if (RUN_USING_ENCODER || use2WheelTrackingLocalizer) {
            ...
            org.firstinspires.ftc.teamcode.util.BNO055IMUUtil.remapZAxis(imu, org.firstinspires.ftc.teamcode.util.AxisDirection.NEG_X);
        }
        ...
        if (use2WheelTrackingLocalizer) {
            setLocalizer(new TwoWheelTrackingLocalizer(hardwareMap, this));
        } else if (use3WheelTrackingLocalizer) {
