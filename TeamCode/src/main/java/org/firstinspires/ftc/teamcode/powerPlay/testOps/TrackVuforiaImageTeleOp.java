...
@Disabled
@TeleOp(group = "TestOp")
public class TrackVuforiaImageTeleOp extends OpMode {
    // Declare OpMode members
    private ElapsedTime runtime = null;
    private ElapsedTime loopTime = null;

    FalconVuforia vuforia;
    org.firstinspires.ftc.teamcode.VuforiaImage image;
    ...
    public void loop() {
        FalconLogger.enter();
        loopTime.reset();
        image = vuforia.locateNavigationImage();
        if (gamepad1.a) {
            vuforia.saveImage();
        }
